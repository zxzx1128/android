...
public class FoodUtils {
    ...
    //能量
    private static final String[] food_calorie=
            {
                    "116 大卡(每100克)","395 大卡(每100克)","54 大卡(每100毫升)","17 大卡(每100克)","53 大卡(每100克)"
                    ,"144 大卡(每100克)","548 大卡(每100克)","43 大卡(每100毫升)","246 大卡(每100克)","93 大卡(每100克)"
                    ,"52 大卡(每100毫升)","0 大卡(每100毫升)","122 大卡(每100克)","133 大卡（每100克）","203 大卡(每100克)"
                    ,"112 大卡(每100克)","31 大卡(每100毫升)","100 大卡(每100克)","81 大卡(每100克)","15 大卡(每100克)"
                    ,"85 大卡(每100克)","22 大卡(每100克)","84 大卡(每100克)","13 大卡(每100克)","21 大卡(每100克)"
                    ,"486 大卡(每100克)","151 大卡(每100克)","399 大卡(每100克)","127 大卡(每100克)","78 大卡(每100克)"
                    ,"1000大卡（每100克）","232大卡（每100克）","343大卡（每100克）","323大卡（每100克）","43大卡（每100克）"
                    ,"23大卡（每100克）","343大卡（每100克）","134大卡（每100克）","321大卡（每100克）"
            };
    //照片位置
...
//将每个食物与对应的不可搭配，图片，能量，描述搭配好返回
    public static List<FoodBean> getAllFoodList(){
        List<FoodBean> list = new ArrayList<>();
        for(int i=0;i<food.length;i++){
            FoodBean bean = new FoodBean(food[i],food_calorie[i],food1[i],foodjianjie[i],resId[i]);
            list.add(bean);
        }
        return list;
    }
